...
async function updateNavAuth() {
  ...
  const negotiationsLink = document.getElementById('navNegotiations');
  ...
  if (session) {
    ...
    if (negotiationsLink) negotiationsLink.style.display = '';
    ...
    if (negotiationsLink) negotiationsLink.style.display = 'none';
