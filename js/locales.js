...
const HB_TRANSLATIONS = {
  fr: {
    'meta.title': 'HB Commerce | FAYAFI — Huile d\'olive en gros',
    'meta.description': 'FAYAFI — Huile d\'olive extra vierge de Tunisie. Commerce en gros pour professionnels en France.',
    'nav.home': 'Accueil',
    ...
    'hero.lead': 'HB Commerce distribue <strong>FAYAFI</strong> — première pression à froid depuis la Tunisie, pour restaurateurs, traiteurs et grossistes en <strong>France</strong>.',
    'hero.pill1': 'Extra vierge',
    'hero.pill2': 'Tunisie',
    'hero.pill3': 'Vente en gros',
    'hero.cta.order': 'Commander FAYAFI',
    'hero.cta.account': 'Compte professionnel',
    'product.tag': 'Produit phare',
    'product.name': 'FAYAFI — Huile d\'olive extra vierge',
    ...
    'about.import.desc': 'FAYAFI sourcé en Tunisie, qualité extra vierge pour la restauration française.',
    ...
    'brochure.title': 'Brochure FAYAFI — France',
    'brochure.market': 'Marché : France'
  },
  lu: {
    'meta.title': 'HB Commerce | FAYAFI — Olivenöl Grosshandel',
    'meta.description': 'FAYAFI — Natives Olivenöl extra aus Tunesien. Grosshandel für Profis in Luxemburg.',
    ...
    'hero.lead': 'HB Commerce distribue <strong>FAYAFI</strong> pour les professionnels au <strong>Luxembourg</strong> et dans la Grande Région — première pression à froid, Tunisie.',
    ...
    'about.import.desc': 'FAYAFI aus Tunesien — natives Olivenöl extra für Gastronomie und Handel.',
    ...
    'brochure.title': 'Brochure FAYAFI — Luxembourg',
